...
const Store = () => {
  ...
  const books = [
    { id: 1, title: 'The Last Summer', author: 'Emma Hart', price: '$14.99' },
    { id: 2, title: 'Before I Forget', author: 'Nina Torres', price: '$12.99' },
    { id: 3, title: 'The 30-Day Challenge', author: 'Dr. Maya Collins', price: '$16.99' },
    { id: 4, title: "The Mirror's Secret", author: 'James Hunter', price: '$11.99' },
    { id: 5, title: 'The Accidental Roommate', author: 'Max Brooks', price: '$13.99' },
    { id: 6, title: 'The Year I Found Myself', author: 'Lucy Rose', price: '$10.99' },
  ];
    ...
    <div style={{ paddingTop: '80px' }}>
      <div className="container-full">
        <h1 style={{ fontSize: '32px', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Icons.StoreIcon size={32} color="#E50914" />
          Store
        </h1>
        ...
        <div style={{ marginBottom: '48px' }}>
          <h2 style={{ fontSize: '24px', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Icons.CrownIcon size={24} color="#FBBF24" />
            Subscription Plans
          </h2>
          <div style={{
            display: 'grid',
              ...
              >
                ...
                <ul style={{ listStyle: 'none', padding: 0 }}>
                  {plan.features.map((feature, i) => (
                    <li key={i} style={{ color: '#B3B3B3', padding: '4px 0', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <Icons.CheckIcon size={18} color="#22C55E" />
                      {feature}
                    </li>
                  ))}
                </ul>
        ...
        <div>
          <h2 style={{ fontSize: '24px', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Icons.CartIcon size={24} color="#E50914" />
            Books for Sale
          </h2>
          <div style={{
            display: 'grid',
            ...
            {books.map((book) => (
              ...
              >
                <div style={{ fontSize: '48px', marginBottom: '8px' }}>
                  <Icons.BookOpenIcon size={48} color="#4F46E5" />
                </div>
